...
void Output::CreateDrawToolBar() const
{
	...
	MenuItemImages[ITM_BACKGROUND_COLOR] = "images\\MenuItems\\Menu_BACKGROUND_COLOR.jpg";
	MenuItemImages[ITM_BORDER_WIDTH] = "images\\MenuItems\\Menu_BORDER_WIDTH.jpg";
...
image *img = new image("images\\MenuItems\\colors.jpg", JPEG);

void Output::DrawClrPlt() const
{
	pWind->DrawImage(img, UI.width-730, UI.wy+UI.StatusBarHeight);
}

/*void Output::HideClrPlt() const
{
	pWind->SetPen(UI.BkGrndColor, 1);
	pWind->SetBrush(UI.BkGrndColor);
	pWind->DrawRectangle(UI.width-730, UI.wy+UI.StatusBarHeight, UI.width, UI.height - UI.StatusBarHeight);
}*/
